...
const tasks = [
    ...
    { title: "Finish Line", description: "This is the description for Task 6.", number: <FlagIcon />, image: '/badge.png', overlayText: 'AIML' },
];
                            ...
                            <Grid item xs={8} sx={{ display: 'flex', flexDirection: 'column' }}>
                                <Paper elevation={2} sx={{ padding: '1rem', flex: 1, borderRadius: '10px' }}>
                                    ...
                                    <Box sx={{ flex: 1 }}>
                                        ...
                                        {selectedTask.image && (
                                            <Box sx={{ position: 'relative', marginTop: '7rem', textAlign: 'center' }}>
                                                <img src={selectedTask.image} alt={selectedTask.title} style={{ display: 'block', maxWidth: '50%', margin: '10 auto',marginLeft:'14rem', borderRadius: '10px' }} />
                                                {selectedTask.overlayText && (
                                                    <Typography
                                                        variant="h6"
                                                        sx={{
                                                            position: 'absolute',
